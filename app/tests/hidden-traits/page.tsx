...
const Q = [
  "Which phrase feels most like you today?",
  "Pick the image that draws you in (imagine)."];
const OPT = [
  ["Quiet strength", "Curious explorer", "Gentle challenger"],
  ["A misty forest", "A sunlit desk", "A bustling market"],
];

export default function HiddenTraits() {
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] py-20 px-6">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-extrabold text-white mb-6">Find Your Hidden Personality Traits</h1>
        <p className="text-slate-300 mb-8">Simple, evocative cues to surface patterns.</p>
      ...
      <FeedbackModal open={showFb} context="test:hidden-traits" onClose={() => { setShowFb(false); router.push('/profile'); }} />
    </main>
  );
}
